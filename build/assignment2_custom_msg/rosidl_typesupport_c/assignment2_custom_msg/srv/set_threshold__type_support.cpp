...
static const _SetThreshold_Request_type_support_symbol_names_t _SetThreshold_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, assignment2_custom_msg, srv, SetThreshold_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, assignment2_custom_msg, srv, SetThreshold_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, assignment2_custom_msg, srv, SetThreshold_Request)() {
  return &::assignment2_custom_msg::srv::rosidl_typesupport_c::SetThreshold_Request_message_type_support_handle;
}
...
static const _SetThreshold_Response_type_support_symbol_names_t _SetThreshold_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, assignment2_custom_msg, srv, SetThreshold_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, assignment2_custom_msg, srv, SetThreshold_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, assignment2_custom_msg, srv, SetThreshold_Response)() {
  return &::assignment2_custom_msg::srv::rosidl_typesupport_c::SetThreshold_Response_message_type_support_handle;
}
...
static const _SetThreshold_Event_type_support_symbol_names_t _SetThreshold_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, assignment2_custom_msg, srv, SetThreshold_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, assignment2_custom_msg, srv, SetThreshold_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, assignment2_custom_msg, srv, SetThreshold_Event)() {
  return &::assignment2_custom_msg::srv::rosidl_typesupport_c::SetThreshold_Event_message_type_support_handle;
}
...
static const _SetThreshold_type_support_symbol_names_t _SetThreshold_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, assignment2_custom_msg, srv, SetThreshold)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, assignment2_custom_msg, srv, SetThreshold)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, assignment2_custom_msg, srv, SetThreshold)() {
  return &::assignment2_custom_msg::srv::rosidl_typesupport_c::SetThreshold_service_type_support_handle;
}
