...
bool assignment2_custom_msg__msg__obstacle_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("assignment2_custom_msg.msg._obstacle_info.ObstacleInfo", full_classname_dest, 54) == 0);
  }
  assignment2_custom_msg__msg__ObstacleInfo * ros_message = _ros_message;
  {  // distance
...
PyObject * assignment2_custom_msg__msg__obstacle_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("assignment2_custom_msg.msg._obstacle_info");
