...
static const _ObstacleInfo_type_support_symbol_names_t _ObstacleInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment2_custom_msg, msg, ObstacleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assignment2_custom_msg, msg, ObstacleInfo)),
  }
};
...
{
  return &::assignment2_custom_msg::msg::rosidl_typesupport_cpp::ObstacleInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, assignment2_custom_msg, msg, ObstacleInfo)() {
  return get_message_type_support_handle<assignment2_custom_msg::msg::ObstacleInfo>();
}
