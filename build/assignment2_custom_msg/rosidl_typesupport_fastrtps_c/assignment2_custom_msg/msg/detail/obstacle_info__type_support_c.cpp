...
#include "assignment2_custom_msg/msg/detail/obstacle_info__rosidl_typesupport_fastrtps_c.h"
...
using _ObstacleInfo__ros_msg_type = assignment2_custom_msg__msg__ObstacleInfo;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = assignment2_custom_msg__msg__ObstacleInfo;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const assignment2_custom_msg__msg__ObstacleInfo * ros_message = static_cast<const assignment2_custom_msg__msg__ObstacleInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_assignment2_custom_msg__msg__ObstacleInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  assignment2_custom_msg__msg__ObstacleInfo * ros_message = static_cast<assignment2_custom_msg__msg__ObstacleInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_assignment2_custom_msg__msg__ObstacleInfo(cdr, ros_message);
}

static uint32_t _ObstacleInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_assignment2_custom_msg__msg__ObstacleInfo(
...
static size_t _ObstacleInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_assignment2_custom_msg__msg__ObstacleInfo(
