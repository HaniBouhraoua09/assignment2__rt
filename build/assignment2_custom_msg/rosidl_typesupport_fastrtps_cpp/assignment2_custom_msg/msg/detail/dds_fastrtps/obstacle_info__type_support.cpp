...
#include "assignment2_custom_msg/msg/detail/obstacle_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = assignment2_custom_msg::msg::ObstacleInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const assignment2_custom_msg::msg::ObstacleInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<assignment2_custom_msg::msg::ObstacleInfo *>(
    untyped_ros_message);
...
{
  return &assignment2_custom_msg::msg::typesupport_fastrtps_cpp::_ObstacleInfo__handle;
}
